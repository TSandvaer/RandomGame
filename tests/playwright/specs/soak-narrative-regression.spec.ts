...
test.describe("soak-narrative finding #1 — Room 2 mob-aggro observable after player hit", () => {
  ...
  test(
    ...
    async ({ page, context }) => {
      ...
      await clickAimedAtSpawn(canvas, capture, "NE"); // Mouse-direction attacks (PR #255 / T9 PR #293): aim NE-of-spawn in WORLD coords; helper applies `worldToCanvas` against live camera transform.
